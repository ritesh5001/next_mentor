...
const NAV: NavItem[] = [
  ...
  { href: "/dashboard/profile", label: "Profile", icon: "UserCircle", ready: false },
  ...
  { href: "/dashboard/plan", label: "Upgrade Your Plan", icon: "Sparkles", ready: false },
  ...
  { href: "/dashboard/coupons", label: "Exclusive Coupons", icon: "Ticket", ready: false },
